...
export default function Authentication() {
	...
	const resetPassword = useSelector(
		(state) => state.misc.isResettingPassword
	);
	...
	async function handleSubmit(event) {
		...
		if (otpVerify || signUp || updatePassword)
		...
		<>
			...
			<div className={classes.wrapper}>
				...
				>
					{mailVerify && (
						<h1>
							<u>Mail Verification</u>
						</h1>
					)}
					{otpVerify && (
						<h1>
							<u>OTP Confirmation</u>
						</h1>
					)}
					{login && (
						<h1>
