...
export default function LoginPopUp({
	...
	return (
		<div
			className={`${classes.popUp} ${loginVisible ? classes.showPopUp : ""} ${
				passwordChange && classes.showPopUpPasswordChange
			}`}
		>
			<button
			...
			>
				<div className={classes.sideHeadingText}>{passwordChange ? `Change Password` : `Login`}</div>
			</button>
					...
					<div className={classes.loginPage}>
						<div className={classes.popUpMain} onClick={(e) => e.stopPropagation()}>
							...
							<div className={classes.loginPopupContent}>
								...
								<p className={classes.invisibleButton} onClick={redirectToPasswordChange}>
									Forgot Password?
								</p>
							</div>
							<div className={classes.popUpButtonPlus}>
								...
								<p>
									...
									<span> </span>
									<span className={classes.invisibleButton} onClick={showSignUpPage}>
										Sign Up
									</span>
								</p>
							</div>
